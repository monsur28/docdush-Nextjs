        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div>
            ...
            <p className="mb-6">
              ...
              new feature? We&apos;d love to hear from you! Fill out the form
              and we&apos;ll get back to you as soon as possible.
            </p>

            <div className="mb-6">
              <h3 className="text-xl font-bold mb-2">Our Office</h3>
              <p>Arji Naogaon, Mridhapara</p>
              <p>Naogaon Sadar, 6500</p>
              <p>Naogaon, Dhaka, Bangladesh</p>
            </div>

            <div className="mb-6">
              <h3 className="text-xl font-bold mb-2">Email</h3>
              <p>official@twintechsoft.com</p>
              <p>admin@twintechsoft.com</p>
            </div>
